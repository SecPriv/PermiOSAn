...
with open(f"./data/permissions_paper.matches_w_permissions_{YEAR}.json") as fp:
    apps = json.load(fp)
...
for app_pair in apps:
    ...
    # print(app_pair.get("_id"))
    if app_pair.get("ios_id") == "LiveScore":
        print(app_pair)
        #print(ios_permissions)
        #print(android_permissions)
    ...
    #     
    # else:
    #     print(f"DIFFERENCES 0 for app {app_pair['_id']}")
    #print(apps_w_diffs)
